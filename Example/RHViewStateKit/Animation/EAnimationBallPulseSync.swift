//
//  EAnimationBallPulseSync.swift
//  app
//
//  Created by Bagus andinata on 02/03/21.
...
class EAnimationBallPulseSync: EActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circles
        for i in 0 ..< 3 {
            let circle = EActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
